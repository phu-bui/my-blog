...
async function getExistingexistingBlockId() {
  const res = await fetch(`${API_ENDPOINT}/queryCollection?src=initial_load`, {
    method: 'POST',
    headers: {
      cookie: `token_v2=${NOTION_TOKEN}`,
      'content-type': 'application/json',
    ...
    body: JSON.stringify({
      source: {
        type: "collection",
        id: "17577edd-b16a-8174-94ce-000b1bef98b7",
        spaceId: "ccae64d3-72c4-4ba1-bbd3-e16e6e89c3db"
      },
      collectionView: {
        id: "17577edd-b16a-819c-a9fc-000c1febdfe2",
        spaceId: "ccae64d3-72c4-4ba1-bbd3-e16e6e89c3db"
      },
      loader: {
        reducers: {
        ...
        sort: [],
        searchQuery: "",
        userId: "175d872b-594c-81fa-9a6b-000266233d0c",
